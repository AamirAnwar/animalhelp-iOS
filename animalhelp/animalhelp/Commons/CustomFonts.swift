...
let CustomFontSmallBodyMedium = UIFont(name: "AvenirNext-Medium", size: 14)!
let CustomFontButtonTitle = UIFont(name: "AvenirNext-DemiBold", size: 19)!
let CustomFontDemiMedium = UIFont(name: "AvenirNext-DemiBold", size: 16)!
...
let CustomFontBodyParagraphMedium = UIFont(name: "AvenirNext-Medium", size: 16)!
